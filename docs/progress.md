...
- [x] **손그림 입력(하이브리드)**: 손가락/펜으로 밑줄·동그라미·화살표를 그으면 caret/좌표 인식으로 글자·표시에 자동 매핑(addAnnotation/addRelation). 도구 없으면 읽기·스크롤. P·S/Q·A/나열도 화살표+유형선택으로 표기. — 태블릿 실제 검증 필요
